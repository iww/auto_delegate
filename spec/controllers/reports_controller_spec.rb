...
describe ReportsController do
  ...
  let(:valid_attributes) { { "start_date" => "2014-02-25 03:53:38" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved report as @report" do
        ...
        post :create, {:report => { "start_date" => "invalid value" }}, valid_session
        expect(assigns(:report)).to be_a_new(Report)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested report" do
        ...
        expect_any_instance_of(Report).to receive(:update).with({ "start_date" => "2014-02-25 03:53:38" })
        put :update, {:id => report.to_param, :report => { "start_date" => "2014-02-25 03:53:38" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the report as @report" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Report).to receive(:save).and_return(false)
        put :update, {:id => report.to_param, :report => { "start_date" => "invalid value" }}, valid_session
        expect(assigns(:report)).to eq(report)
      end
